                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('news.update',['news'=>$News['id']]) }}" method="post" id="editUser"
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="js-example-basic-single col-sm-12" name="player_id"    class="form-control selectric ">
                                        ...
                                        <option value="{{ $user['user_id'] }}" {{ ($News['player_id'] == $user['user_id']) ? "selected":(old("player_id") == $user['user_id'] ? "selected":"") }}>{{ $user['name'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <input  name="description" value="{{ old('description',$News['description']) }}" class="summernote-simple form-control" required>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <select class="js-example-basic-single col-sm-12" name="status_id"    class="form-control selectric ">
                                            ...
                                            <option value="{{ $statuse['id'] }}" {{ ($News['status_id'] == $statuse['id']) ? "selected":(old("status_id") == $statuse['id'] ? "selected":"") }}>{{ $statuse['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <a href="{{ url('news/'.$News['id'].'/edit/assets') }}" class="btn btn-blue" id="img">Edit Image</a>
