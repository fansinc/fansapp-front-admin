                ...
                <!-- Page-header end -->
                    ...
                    <div class="page-body">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <div class="row ">
                                            <div class="col-sm-4">
                                                <a class="btn btn-dark" href="{{ route('roles.create') }}" role="button">Add New</a>
                                            </div>
                                            <div class="col-sm-4">
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="col">
                                                    <ul id="pagination" class="" style="display: -webkit-box;">
                                                        <li style="padding: 2px;"><a href="{{ route('role.index',$page=1) }}" class="btn  @if($pagination['current_page']==1) {{ "disabled" }} @endif" style="box-shadow: 0 2px 6px #acb5f6;
                               border-radius:30px">First</a></li>
                                                        ...
                                                        @endphp
                                                        <li style="padding: 2px;"><a href="{{ route('role.index',$page) }}" class="btn " style="box-shadow: 0 2px 6px #acb5f6;
                      ...
                      border-radius:30px">Next</a></li>
                                                        ...
                                                        {
                                                        @endphp
                                                        <li style="padding: 2px;"> <a href="{{ route('role.index',$pagination['total_pages']) }}" class="btn  float-right" style="box-shadow: 0 2px 6px #acb5f6;
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="display: -webkit-box;">
                                                            ...
                                                            <a data-toggle="tooltip" class=" d-inline font1 edit-confirmation" data-placement="top" title="Edit" href="{{ url('roles/'.$id.'/edit') }}" role="button" style="color: #007bff;padding: 0.5rem;"><i class="icofont icofont-ui-edit"></i></a>
                                                            <form id="delete_from_{{$role['id']}}" method="POST" action="{{ route('roles.destroy', $role['id']) }}">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <a data-toggle="tooltip" class="_delete_data" data-placement="top" title="Delete" href="javascript:void(0);" data-id="{{$role['id']}}" role="button" style="color: #007bff;padding: 0.5rem;"><i class="icofont icofont-trash"></i></a>
