                    ...
                    <!-- Authentication card start -->
                            ...
                            @endif
                                <div class="row m-b-20">
                                    ...
                                    <div class="row m-t-3">
                                        <div class="col-md-12">
                                            <a href="{{ route('forgot_password') }}" class="btn bg btn-block waves-effect waves-light text-center m-b-20">Back to Forgot Password</a>
                                        </div>
                                    </div>

                                    <div class="row m-t-3">
                                        <div class="col-md-12">
                                            <a href="{{ route('home') }}" class="btn bg btn-block waves-effect waves-light text-center m-b-20">Back to Login</a>
                                        </div>
                                    </div>
