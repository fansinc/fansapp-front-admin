                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{route('myweek.update',['myweek'=>$MyWeek['id']]) }}" method="post" id="editUser"
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select class="js-example-basic-single col-sm-12" name="player_id"    class="form-control selectric ">
                                        ...
                                        <option value="{{ $user['user_id'] }}" {{ ($MyWeek['player_id'] == $user['user_id']) ? "selected":(old("player_id") == $user['user_id'] ? "selected":"") }}>{{ $user['name'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <select class="js-example-basic-single col-sm-12" name="status_id"    class="form-control selectric ">
                                            ...
                                            <option value="{{ $statuse['id'] }}" {{ ($MyWeek['status_id'] == $statuse['id']) ? "selected":(old("status_id") == $statuse['id'] ? "selected":"") }}>{{ $statuse['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <a href="{{ url('myweek/'.$MyWeek['id'].'/edit/assets') }}" class="btn btn-blue" id="img">Edit Image</a>
