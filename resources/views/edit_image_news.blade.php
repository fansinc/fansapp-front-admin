                        ...
                        <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10 offset-1 card">
                                                            ...
                                                            <div class="card-block">
                                                                <form id="uploadform" action="{{url('assets/storeimage/news/'.$editdata['id']) }}" method="post" id="addprocat"
                                                                    enctype="multipart/form-data">
                                                                    {{-- @method('PATCH') --}}
                                                                  @csrf
                                                                <p id="msg"></p>
                                                                <div class="sub-title">News Picture</div>
                            ...
                            <div class="form-group row mb-5">
                                ...
                                <div class="col-sm-12 col-md-7 offset-5">
                                        ...
                                        <a href="{{ url('news/'.$editdata['id'].'/edit') }}"
